...
# Load model
try:
    external_model = tf.keras.models.load_model(MODEL_PATH)
    input_tensor = Input(shape=(224, 224, 3))
    output_tensor = external_model(input_tensor)
    model = Model(inputs=input_tensor, outputs=output_tensor)
    logging.info("Model loaded successfully using tf.keras.models.load_model")
